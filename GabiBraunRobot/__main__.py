...
PM_START_TEXT = """
`Hey There!` [🤣](https://telegra.ph/file/a085d2cd14d7a316fd6e1.jpg) `My name is` *Khaby*
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD KHABY TO YOUR GROUP ➕️",url="t.me/KHABYROBOT?startgroup=true"),
    ],
    [
        InlineKeyboardButton(
    ...
    [     InlineKeyboardButton(
            text="TVA GROUP❓", url="https://t.me/TVA_AGENCY"),
    
    ],
    [
        InlineKeyboardButton(
            text=" Update Chnnel⁉️", url="https://t.me/TVANETWORK"),
    ],
    [
        InlineKeyboardButton(
...
InlineKeyboardButton(
            text="🐱 SUPPORT", url="https://t.me/TVA_AGENCY"
        ),

    ],
    [
        InlineKeyboardButton(
                    text="🗄️ Source Code", url="https://t.me/TVA_AGENCY"
        ),
    ],
]
...
HELP_STRINGS = """
`Hey there! My name is` [KHABY-KEEP SIMPLE]("https://telegra.ph/file/cafa957b326bd7847f0f8.jpg") 
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..😜 I'm *KHABY*
                 \nHere is the [Source Code](https://github.com/FIREEEBOT/Khaby) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
